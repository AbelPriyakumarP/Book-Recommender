...
class DataIngestion:
    ...
    def download_data(self):
        ...
        try:
            ...
            logging.info(f"Downloaded data successfully: {zip_file_path}")
    ...
    def extract_zip_file(self, zip_file_path: str):
        ...
        try:
            if not zipfile.is_zipfile(zip_file_path):
                raise AppException(f"The downloaded file is not a valid zip file: {zip_file_path}", sys)
            ...
            logging.info(f"Extracted zip file: {zip_file_path} into directory: {ingested_dir}")
    ...
    def initiate_data_ingestion(self):
        """
        Run the full data ingestion pipeline: download and extract data.
        """
        try:
